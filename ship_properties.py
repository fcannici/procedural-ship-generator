...
class ShipGeneratorProperties(bpy.types.PropertyGroup):
    ...
    bodega_closed_front: bpy.props.BoolProperty(
        name="Cerrar Bodega Frontal",
        description="Genera una pared que cierra la bodega por la parte delantera de esta sección",
        default=False,
        update=update_no_sync
    )
